...
namespace Academe\Elavon\Epg\Psr7\Tests\Unit\Messages\Response\PazePayment;

use Academe\Elavon\Epg\Psr7\Dtos\PazePayment;
use Academe\Elavon\Epg\Psr7\Dtos\ErrorResponse;
use Academe\Elavon\Epg\Psr7\Messages\Response\PazePayment\PazePaymentResponse;
use Academe\Elavon\Epg\Psr7\Support\Stream;
use PHPUnit\Framework\TestCase;
use Psr\Http\Message\ResponseInterface;

class PazePaymentResponseTest extends TestCase
{
    ...
    public function test_construct_withSuccessResponse_parsesPazePayment(): void
    {
        $responseData = [
            'id' => 'payment_123',
            'href' => 'https://api.example.com/paze-payments/payment_123',
