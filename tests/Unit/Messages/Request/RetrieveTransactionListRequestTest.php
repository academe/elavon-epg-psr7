...
class RetrieveTransactionListRequestTest extends TestCase
{
    ...
    public function test_build_withoutParams_createsValidRequest(): void
    {
        ...
        $this->assertSame('https://api.eu.elavonpayments.com/transactions', (string) $psrRequest->getUri());
    ...
    public function test_build_withParams_includesQueryString(): void
    {
        ...
        $this->assertStringStartsWith('https://api.eu.elavonpayments.com/transactions?', $uri);
    }
    ...
    public function test_build_withCustomBaseUri_usesCustomUri(): void
    {
        ...
        // Assert
        $this->assertStringStartsWith('https://custom.api.example.com/transactions?', $uri);
    }
