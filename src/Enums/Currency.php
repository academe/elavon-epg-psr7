 ...
 *
 * This enum contains the most commonly used currency codes.
 * The Elavon Payment Gateway supports a subset of ISO 4217 currencies
 * depending on the merchant's configuration and processor account.
 */
enum Currency: string
{
    ...
    case SLL = 'SLL'; // Sierra Leonean Leone (old)
