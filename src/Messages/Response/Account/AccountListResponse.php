...
class AccountListResponse
{
    ...
    /**
     * Creates an AccountListResponse from a PSR-7 response.
     *
     * @param ResponseInterface $response PSR-7 HTTP response
     * @return static
     */
    ...
    /**
     * Gets the accounts from a successful response.
     *
     * @return array<Account>|null Array of accounts on success, null on error
     */
