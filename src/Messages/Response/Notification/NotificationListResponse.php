...
class NotificationListResponse
{
    ...
    /**
     * Creates a NotificationListResponse from a PSR-7 response.
     *
     * @param ResponseInterface $response PSR-7 HTTP response
     * @return static
     */
    ...
    /**
     * Gets the notifications from a successful response.
     *
     * @return array<Notification>|null Array of notifications on success, null on error
     */
