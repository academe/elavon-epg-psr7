...
class PaymentMethodSessionListResponse
{
    ...
    private readonly ?array $paymentMethodSessions;
    ...
    public function __construct(private readonly ResponseInterface $response)
    {
        ...
        if ($this->isSuccessful()) {
            ...
            $this->paymentMethodSessions = $data['items'];
    ...
    /**
     * Creates a PaymentMethodSessionListResponse from a PSR-7 response.
     *
     * @param ResponseInterface $response PSR-7 HTTP response
     * @return static
     */
    ...
    /**
     * Gets the payment method sessions from a successful response.
     *
     * @return array<PaymentMethodSession>|null Array of payment method sessions on success, null on error
     */
    public function getPaymentMethodSessions(): ?array
    {
