 ...
 * ```
 */
class StoredAchPaymentListResponse
{
    use HandlesErrors;

    private readonly ?array $storedAchPayments;
    ...
    public function __construct(private readonly ResponseInterface $response)
    {
        ...
        if ($this->isSuccessful()) {
            ...
            $this->storedAchPayments = $data['items'];
    ...
    /**
     * Creates a StoredAchPaymentListResponse from a PSR-7 response.
     *
     * @param ResponseInterface $response PSR-7 HTTP response
     * @return static
     */
    ...
    /**
     * Gets the stored ACH payments from a successful response.
     *
     * @return array<StoredAchPayment>|null Array of stored ACH payments on success, null on error
     */
    public function getStoredAchPayments(): ?array
    {
        return $this->storedAchPayments;
    }
