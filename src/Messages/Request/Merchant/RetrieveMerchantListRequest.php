...
/**
 * Retrieve Merchant List Request.
 *
 * Builds a PSR-7 request for retrieving paginated merchant lists (GET /merchants).
 *
 ...
 */
class RetrieveMerchantListRequest implements RequestMessage
{
    ...
    {
        $request = $this->getRequestFactory()->createRequest('GET', '/merchants');
