 ...
 *
 * Builds a PSR-7 request for retrieving paginated terminal lists (GET /terminals).
 *
 ...
 */
class RetrieveTerminalListRequest implements RequestMessage
{
    ...
    {
        $request = $this->getRequestFactory()->createRequest('GET', '/terminals');
