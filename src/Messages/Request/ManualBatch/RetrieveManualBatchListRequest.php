...
/**
 * Retrieve Manual Batch List Request.
 *
 * Builds a PSR-7 request for retrieving paginated manual batch lists (GET /manual-batches).
 *
 ...
 * ```php
 * use Academe\Elavon\Epg\Psr7\Dtos\QueryParams;
 * use Academe\Elavon\Epg\Psr7\Messages\Request\ManualBatch\RetrieveManualBatchListRequest;
 * use Academe\Elavon\Epg\Psr7\Support\ElavonApiFactory;
 *
 * // Build the base request with pagination
 * $queryParams = QueryParams::create()->withLimit(50);
 * $request = (new RetrieveManualBatchListRequest($queryParams))->build();
 *
 ...
 */
class RetrieveManualBatchListRequest implements RequestMessage
{
    ...
    {
        $request = $this->getRequestFactory()->createRequest('GET', '/manual-batches');
