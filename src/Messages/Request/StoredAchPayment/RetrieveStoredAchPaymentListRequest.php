 ...
 * $request = (new RetrieveStoredAchPaymentListRequest($queryParams))->build();
 *
 ...
 */
class RetrieveStoredAchPaymentListRequest implements RequestMessage
{
    ...
    {
        $request = $this->getRequestFactory()->createRequest('GET', '/stored-ach-payments');
