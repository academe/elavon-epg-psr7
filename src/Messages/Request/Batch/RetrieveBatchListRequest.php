...
/**
 * Retrieve Batch List Request.
 *
 * Builds a PSR-7 request for retrieving paginated batch lists (GET /batches).
 *
 ...
 * $request = (new RetrieveBatchListRequest($queryParams))->build();
 *
 ...
 */
class RetrieveBatchListRequest implements RequestMessage
{
    ...
    {
        $request = $this->getRequestFactory()->createRequest('GET', '/batches');
