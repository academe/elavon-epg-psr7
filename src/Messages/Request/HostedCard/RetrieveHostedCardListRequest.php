 ...
 * $request = (new RetrieveHostedCardListRequest($queryParams))->build();
 *
 ...
 */
class RetrieveHostedCardListRequest implements RequestMessage
{
    ...
    {
        $request = $this->getRequestFactory()->createRequest('GET', '/hosted-cards');
